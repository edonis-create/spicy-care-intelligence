export const PHENOTYPES = [
  {
    ...
    name: "Low Risk",
    label: "P1 – Low Risk",
    description: "Lower morbidity and medication use. Stable, low-cost population.",
    clinicalTier: 1,
    ragStatus: "green",
    colorName: "blue",
    color: {
  ...
  },
  {
    id: "P2",
    name: "Moderate Risk",
    label: "P2 – Moderate Risk",
    description: "Moderate condition burden with stable healthcare utilization.",
    clinicalTier: 2,
    ragStatus: "green",
    colorName: "red",
    color: {
  ...
  {
    id: "P3",
    name: "High Medication Need",
    label: "P3 – High Medication Need",
    description: "Chronic profile with high prescription intensity. Requires active medication management.",
    clinicalTier: 3,
    ragStatus: "amber",
    colorName: "green",
    color: {
  ...
  },
  {
    id: "P4",
    name: "Chronic, Stable",
    label: "P4 – Chronic, Stable",
    description: "Chronic disease profile with lower medication use. Manageable care needs, watch for escalation.",
    clinicalTier: 4,
    ragStatus: "amber",
    colorName: "amber",
    color: {
  ...
  },
  {
    ...
    label: "P5 – High Complexity",
    description: "Highest clinical complexity and utilization. Priority intervention group — requires coordinated care.",
    clinicalTier: 5,
    ragStatus: "red",
    colorName: "purple",
    color: {
